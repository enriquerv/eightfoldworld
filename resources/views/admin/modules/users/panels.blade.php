<div class="tab-pane fade show active" id="tab1">
    ...
    <div class="form-group row mb-3 {{ $errors->first('first_name') ? 'has-error' : '' }}">
    ...
    <div class="form-group row mb-3 {{ $errors->first('last_name') ? 'has-error' : '' }}">
    ...
    <div class="form-group row mb-3 {{ $errors->first('password') ? 'has-error' : '' }}">
        ...
        <div class="col-sm-10">
            ...
            @isset($item)
                <p class="help-block text-info small"><i class="fa fa-info-circle"></i> {{ trans('strings.help.password') }}</p>
            @endisset
            <span class="help-block">{{ $errors->first('password', ':message') }}</span>
        </div>
    </div>

    <div class="form-group row mb-3 {{ $errors->first('password_confirm') ? 'has-error' : '' }}">
    ...
    <div class="form-group row mb-3 {{ $errors->first('role_id') ? 'has-error' : '' }}">
